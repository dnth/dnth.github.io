...
The [authors of Fastdup](https://www.visual-layer.com/) had used it to uncover over **1.2M duplicates** and **104K data train/val leaks** in the ImageNet-21K dataset.
...
+ `data/` -- Folder to store all dataset.
